...
p <- ggplot(halldorsson_explore, aes(x = age_father, y = age_mother)) +
  ...
  geom_smooth(aes(x = age_father, y = age_mother, color = "orange"), method = "lm", show.legend = FALSE) +
  xlab("Age of Father") +
  ylab("Age of Mother")

ggsave("figure_02_age_correlation.png", plot = p, width = 8, height = 5, path = "./../../Figures/")
```
